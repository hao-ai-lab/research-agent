"""Prompt skill manager extracted from server.py."""
...
class PromptSkillManager:
    ...
    def __init__(self, skills_dir: Optional[str] = None):
        self.skills_dir = skills_dir or os.path.join(os.path.dirname(os.path.abspath(__file__)), "prompt_skills")
    ...
    def _parse_file(self, filepath: str, folder_name: str) -> dict:
        ...
        return {
            ...
            "category": frontmatter.get("category", "prompt"),
            "built_in": True,
